...
HD_PWD='C:/Xilinx/Vivado_Projects/ece449project/InitialPipeline.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log control_path_v3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source control_path_v3.tcl -notrace
