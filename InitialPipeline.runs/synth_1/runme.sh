...
HD_PWD='C:/Xilinx/Vivado_Projects/ece449project/InitialPipeline.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log control_path_v3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source control_path_v3.tcl
