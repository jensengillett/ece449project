...
synth_design -top control_path_v3 -part xc7a35tcpg236-1
...
write_checkpoint -force -noxdef control_path_v3.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file control_path_v3_utilization_synth.rpt -pb control_path_v3_utilization_synth.pb"
